		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<div class="wrapper">
					...
					<form action="../controller/c_buatArtikel.php" method="POST" enctype="multipart/form-data" id="kolom">
			            ...
			            <div class="form-group" style="width: 30%;">
			            	...
			            	<select class="form-control" name="saran">
			            		...
			            		<option value="PH">Lahan dengan masalah PH</option>
			            		<option value="Air">Lahan dengan masalah sumber air</option>
			            		<option value="Tanah">Lahan dengan masalah kesuburan tanah</option>
			            	</select>
			            </div>

			            <div class="form-group" >
			            	<label>Isi Artikel</label>
			            	<textarea id="isinya" name="isi" class="form-control" rows="10" cols="5"></textarea>
			            </div>
